      ...
      <div className="container mx-auto max-w-4x1 p-2 py-12 flex flex-col md:flex-row">
        <div className="basis-1/2">
          <h1 className="mb-6 text-center md:text-left ">
            ...
            <span className="font-headline text-5xl font-semibold text-center md:text-left">
              Felipe
            </span>
          ...
          <p className="text-gray-600 my-6 text-center md:text-left">
            ...
            transformar a realidade por meio de interfaces
            de usuário envolventes e funcionais.
          </p>
          <div className="flex items-center gap-1 justify-center md:justify-start gap 2">
            ...
            <a
              href="https://drive.google.com/file/d/1Njg3O5hwzN6lCfAUbFhjsydWDhhk0YO_/view?usp=sharing"
