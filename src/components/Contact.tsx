...
export function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 75 9.8241-0325",
      link: "https://wa.me/5575982410325?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "contato.felipenonato@gmail.com",
      link: "mailto:contato.felipenonato?subject=Olá...",
